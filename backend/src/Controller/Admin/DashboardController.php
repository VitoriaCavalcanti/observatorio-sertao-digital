...
final class DashboardController extends AbstractController
{
    ...
    {
        $pendentes = $instituicoes->count(['statusCadastro' => 'em_analise']) + $instituicoes->count(['situacaoRevisao' => 'em_analise']) + $projetos->count(['statusCadastro' => 'em_analise']) + $projetos->count(['situacaoRevisao' => 'em_analise']) + $indicadores->count(['statusCadastro' => 'em_analise']) + $indicadores->count(['situacaoRevisao' => 'em_analise']);
